function [ flag ] = figsf_BarScatPairedOpt1( srcTable, VarNames, sBasicStats, CTitle, CVLabel, outputGraph, outputFileNameBase)
%
% 
...
for i = 1:length(VarNames)
    Off = srcTable.(VarNames{i})(srcTable.Laser == 0);
    On  = srcTable.(VarNames{i})(srcTable.Laser == 1);
    
    % building a plot
    [ hs ] = figf_BarPlotPairedOpt1( sBasicStats(i).Mean, [Off'; On'], i ); % srcVecBar, srcMatScat, fignum
