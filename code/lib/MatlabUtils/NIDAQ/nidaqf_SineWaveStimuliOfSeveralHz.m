function nidaqf_SineWaveStimuliOfSeveralHz( sinewaveHz, ScaledVoltage, cycles, mintime, Latency, afterpause, trials )
%
%   nidaqf_SineWaveStimuliOfSeveralHz( sinewaveHz, ScaledVoltage, cycles, mintime, Latency, afterpause, trials )
...
display('nidaqf_SineWaveStimuliOfSeveralHz end')