function [ flag ] = lfpprepf_Takeuchi3_dual_500Hz_WOFilt_Template1( RecInfo )
%
% [ flag ] = lfpprepf_Takeuchi3_dual_500Hz_Template1( input_args )
%
...
for k = RecInfo.expnum1
    for l = RecInfo.expnum2
        ...
        if(exist([datfilenamebase '.dat'],'file'))
            ...
            [ flag ] = lfpprepf_Takeuchi3_dual_with2A1D_500Hz_WOFilt( datfilenamebase, RecInfo.sr, RecInfo.srLFP, RecInfo.nChannels);
