function [ flag ] = lfpprepf_Takeuchi3_dual_500Hz_Template1( RecInfo )
%
...
for k = RecInfo.expnum1
    for l = RecInfo.expnum2
        ...
        if(exist([datfilenamebase '.dat'],'file'))
            ...
            [ flag ] = lfpprepf_Takeuchi3_dual_with2A1D_500Hz( datfilenamebase, RecInfo.srLFP, RecInfo.nChannels);
