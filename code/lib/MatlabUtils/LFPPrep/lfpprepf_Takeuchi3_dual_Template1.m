function [ flag ] = lfpprepf_Takeuchi3_dual_Template1( RecInfo )
%
% [ flag ] = lfpprepf_Takeuchi3_dual_Template1( input_args )
%
% This function conducts pre-processing of dat files including resampling, DC removal,
...
mkdir([RecInfo.DataFolder '\raw_data'])
...
for k = RecInfo.expnum1
    for l = RecInfo.expnum2
        ...
        if(exist([datfilenamebase '.dat'],'file'))
            ...
            [ flag ] = lfpprepf_Takeuchi3_dual_with2A1D( datfilenamebase, RecInfo.sr, RecInfo.srLFP, RecInfo.nChannels);
            movefile([datfilenamebase '_1_LFP_reorg.dat'], [RecInfo.datfilenamebase num2str(k,'%02.f') '_' num2str(l,'%02.f') '_1_LFP_reorg.dat']); % renaming
            movefile([datfilenamebase '_2_LFP_reorg.dat'], [RecInfo.datfilenamebase num2str(k,'%02.f') '_' num2str(l,'%02.f') '_2_LFP_reorg.dat']); % renaming
            movefile([datfilenamebase '_1_adc.dat'], [RecInfo.datfilenamebase num2str(k,'%02.f') '_' num2str(l,'%02.f') '_1_adc.dat']); % renaming
            movefile([datfilenamebase '_2_adc.dat'], [RecInfo.datfilenamebase num2str(k,'%02.f') '_' num2str(l,'%02.f') '_2_adc.dat']); % renaming
