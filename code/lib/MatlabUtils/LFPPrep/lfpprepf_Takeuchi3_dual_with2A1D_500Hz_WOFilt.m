function [ flag ] = lfpprepf_Takeuchi3_dual_with2A1D_500Hz_WOFilt( datfilenamebase, sr, srLFP, nChannels)
%
% [ flag ] = lfpprepf_Takeuchi3_dual_with2A1D_500Hz( datfilenamebase, sr, srLFP, nChannels)
%
...
for i = 1:2
    ...
    copyfile([datfilenamebase '_reorg.dat'], [datfilenamebase '_' num2str(i) '_LFP_reorg.dat'])
