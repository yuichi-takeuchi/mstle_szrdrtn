function [ flag ] = lfpprepf_Takeuchi5_C3324_LowCut( datfilenamebase, sr, srLFP, nChannels)
%
%
% INPUTS:
...
% Extract the accelerometer channels
...
[returnVar,msg] = RemoveDCfromDat([datfilenamebase '_adc.dat'], 3);
[returnVar,msg] = RemoveDCfromDat([datfilenamebase '_reorg.dat'], (nChannels - 3));
disp('done.')
